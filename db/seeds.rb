...
#   Character.create(name: "Luke", movie: movies.first)
  ...
  second_post = Post.create(author: first_user, title: 'second not last', text: 'This is my second post',comments_counter: 0, likes_counter: 0)
  third_post = Post.create(author: first_user, title: 'third is the best', text: 'This is my third post',comments_counter: 0, likes_counter: 0)
  forth_post = Post.create(author: second_user, title: 'Hello', text: 'This is my first post',comments_counter: 0, likes_counter: 0)
  fifth_post = Post.create(author: second_user, title: 'socializing', text: 'This platform is cool',comments_counter: 0, likes_counter: 0)
